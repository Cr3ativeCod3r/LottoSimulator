...
function game() 
{
  ...
  function insertNumbers() 
  {
    ...
    {
      var xx = Math.floor(Math.random() * 49) + 1;
...
function czek() 
{
    ...
    for (var i = 0; i < screen.length; i++) 
    {
      ...
      {
        var four = document.getElementById("med");
        four.play(); 
        ff++;
        wygrane=wygrane+150;
      ...
      {
        var mede = document.getElementById("med");
        mede.play(); 
        fi++;
      ...
      {
        var six = document.getElementById("hig");
        six.play(); 
        alert("WYGRAŁEŚ MILION!!!!!")
        sx++;
